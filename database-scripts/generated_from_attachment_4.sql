...
VALUES
('VEHICLE1', 'Generic', 'Van10', 12, 'D', 50.00, 30.00, '2026-03-25 10:00:00')
ON CONFLICT DO NOTHING;
...
(2002, (SELECT id FROM lieu WHERE code='HOT1'), '2026-03-25 10:00:00', 10, (SELECT id FROM lieu WHERE code='AIR')),
(2003, (SELECT id FROM lieu WHERE code='HOT1'), '2026-03-25 10:10:00', 7, (SELECT id FROM lieu WHERE code='AIR')),
(2004, (SELECT id FROM lieu WHERE code='HOT1'), '2026-03-25 10:15:00', 3,  (SELECT id FROM lieu WHERE code='AIR'));
